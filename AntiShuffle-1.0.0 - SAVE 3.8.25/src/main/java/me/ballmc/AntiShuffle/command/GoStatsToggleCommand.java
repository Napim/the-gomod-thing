 ...
 * 
 * Note: This feature requires valid API keys to be set using /gmapi openai YOUR_API_KEY
 */
    ...
    public void handle(String[] args) {
        ...
        if (newState) {
            ...
            if (apiKey == null || apiKey.isEmpty()) {
                ...
                sendMessage(EnumChatFormatting.YELLOW + "Use: /gmapi openai YOUR_API_KEY to set your personal API key");

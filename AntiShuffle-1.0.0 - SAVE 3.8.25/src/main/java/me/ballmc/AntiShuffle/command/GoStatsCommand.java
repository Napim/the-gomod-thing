...
/**
 * Command to toggle the GoStats AI chat functionality.
 */
public class GoStatsCommand extends Command {
    private boolean debugMode = true;

    public GoStatsCommand() {
        super("gostats");
    }
    ...
    public void handle(String[] args) {
        ...
        String statusMessage = String.format(
            "%sGoStats AI chat functionality has been %s%s%s.",
        ...
        System.out.println("GoStatsCommand executed: " + statusMessage);
    }

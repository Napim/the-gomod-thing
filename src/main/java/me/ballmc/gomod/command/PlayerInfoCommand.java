        ...
        new Thread(() -> {
            try {
                ...
                if (statusResponse.get("success").getAsBoolean() && 
                    ...
                    message.append(EnumChatFormatting.DARK_GRAY).append("[").append(EnumChatFormatting.DARK_GREEN).append("gomod").append(EnumChatFormatting.DARK_GRAY).append("] ");
                    message.append(EnumChatFormatting.GREEN).append("Player Info for ").append(playerName).append(":\n");
